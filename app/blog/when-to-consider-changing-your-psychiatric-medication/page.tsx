...
export const metadata: Metadata = {
  title: 'When to Consider Changing Your Psychiatric Medication | Arlene Holland',
  description: 'Learn the signs that it may be time to discuss medication changes with your provider. Expert guidance on psychiatric medication management and mental health treatment.',
  keywords: 'psychiatric medication, medication change, mental health treatment, medication management, antidepressants, mood stabilizers',
}
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-5xl font-light leading-tight text-center mb-8" style={{ fontFamily: 'Cormorant, serif' }}>
            When to Consider Changing Your Psychiatric Medication
          </h1>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <ul className="space-y-3 mb-6">
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              ...
              <span>Suicidal thoughts or significant worsening of depression or anxiety</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span>Allergic reactions such as rash, hives, or difficulty breathing</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span>Severe agitation, mania, or psychotic symptoms</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span>Signs of serotonin syndrome (confusion, rapid heart rate, high fever, muscle rigidity)</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
          ...
          <ul className="space-y-3 mb-6">
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              ...
              <span><strong>Keep a symptom journal:</strong> Track your mood, anxiety levels, side effects, and any changes in symptoms over several weeks</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span><strong>Be specific:</strong> Instead of "I don't feel better," try "I'm still having panic attacks three times a week"</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span><strong>Discuss all side effects:</strong> Even ones that seem minor or embarrassing—they're important clinical information</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span><strong>Mention other medications:</strong> Including over-the-counter drugs, supplements, and herbal remedies</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span><strong>Ask questions:</strong> About alternative medications, expected timelines, and what to watch for</span>
            </li>
            <li className="flex items-start gap-3 text-[var(--color-ink)] leading-loose">
              <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <span><strong>Never stop suddenly:</strong> Many psychiatric medications require gradual tapering to avoid withdrawal symptoms</span>
            </li>
          </ul>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up">
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-light text-[var(--color-ink)] mb-3 group-hover:text-[var(--color-primary)] transition-colors" style={{ fontFamily: 'Cormorant, serif' }}>
                  Understanding Anxiety: Types, Symptoms, and Treatment Options
                </h4>
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Learn about different anxiety disorders and evidence-based treatment approaches.
                </p>
                <div className="text-[var(--color-primary)] text-sm font-medium group-hover:gap-3 flex items-center gap-2 transition-all">
                  Read More
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up">
              ...
              <div className="p-6">
                ...
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Practical, evidence-based techniques to support your mental wellness journey.
                </p>
                <div className="text-[var(--color-primary)] text-sm font-medium group-hover:gap-3 flex items-center gap-2 transition-all">
                  Read More
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up">
              ...
              <div className="p-6">
                ...
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  What to expect and how to make the most of your initial consultation.
                </p>
                <div className="text-[var(--color-primary)] text-sm font-medium group-hover:gap-3 flex items-center gap-2 transition-all">
                  Read More
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl mb-8 text-white/90">
            Our team is here to help you find the right treatment approach.
          </p>
          <a 
            href="/contact" 
